...
public class TestInheritance {
	...
	public static void main(String[] args) {
		...
		Dog myDog3 = new Dog(40, 24,"Kiara", "Maltese", LocalDate.of(2022, 4, 15));
		Cat myCat3= new Cat(10,15, "Tito", 10);
		Bird myBird3 = new Bird(2,6,9.5, false);

		System.out.println(myDog3);
		System.out.println(myCat3);
		System.out.println(myBird3);
		System.out.println();
}
}